class ActionCheckSCoffice_desk: ActionInteractBase
{
	ref Timer		m_CheckSCoffice_deskTimer;

	void ActionCheckSCoffice_desk()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCoffice_desk m_CheckRandomLoot = SCoffice_desk.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCoffice_desk() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCoffice_desk Garbage_BinTimerCast = SCoffice_desk.Cast( targetObject );
			...
			case 4:
				switch (Math.RandomInt(0, 7))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("NailBox", pos) );
