class ActionCheckSCbox_c_multi: ActionInteractBase
{
	ref Timer		m_CheckSCbox_c_multiTimer;

	void ActionCheckSCbox_c_multi()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCbox_c_multi m_CheckRandomLoot = SCbox_c_multi.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCbox_c_multi() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCbox_c_multi Garbage_BinTimerCast = SCbox_c_multi.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
			...
			switch (Math.RandomInt(0, 3))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage4 = ItemBase.Cast( GetGame().CreateObject("Roadflare", pos) );
            ...
            case 2:
				...
				{
    				case 0:
						ItemBase Garbage6 = ItemBase.Cast( GetGame().CreateObject("Rag", pos) );
						SetItemQuantity6(Garbage6);
            		break; 
					
           			case 1:
						ItemBase Garbage7 = ItemBase.Cast( GetGame().CreateObject("Paper", pos) );
			...
			case 4:
				...
				{
    				case 0:
						Weapon_Base Garbage13 = Weapon_Base.Cast( GetGame().CreateObject("Machete", pos) );
