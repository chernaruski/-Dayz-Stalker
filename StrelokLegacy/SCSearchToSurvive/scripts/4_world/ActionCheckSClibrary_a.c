class ActionCheckSClibrary_a: ActionInteractBase
{
	ref Timer		m_CheckSClibrary_aTimer;

	void ActionCheckSClibrary_a()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SClibrary_a m_CheckRandomLoot = SClibrary_a.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSClibrary_a() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SClibrary_a Garbage_BinTimerCast = SClibrary_a.Cast( targetObject );
			...
			case 4:
				switch (Math.RandomInt(0, 7))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("MoneyRuble50", pos) );
