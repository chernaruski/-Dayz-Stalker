class ActionCheckSCshelfs_small_crushed: ActionInteractBase
{
	ref Timer		m_CheckSCshelfs_small_crushedTimer;

	void ActionCheckSCshelfs_small_crushed()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCshelfs_small_crushed m_CheckRandomLoot = SCshelfs_small_crushed.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCshelfs_small_crushed() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCshelfs_small_crushed Garbage_BinTimerCast = SCshelfs_small_crushed.Cast( targetObject );
