class ActionCheckSCclassroom_case_b_crushed: ActionInteractBase
{
	ref Timer		m_CheckSCclassroom_case_b_crushedTimer;

	void ActionCheckSCclassroom_case_b_crushed()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCclassroom_case_b_crushed m_CheckRandomLoot = SCclassroom_case_b_crushed.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCclassroom_case_b_crushed() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCclassroom_case_b_crushed Garbage_BinTimerCast = SCclassroom_case_b_crushed.Cast( targetObject );
