class ActionCheckSCGarbage_Pile4: ActionInteractBase
{
	ref Timer		m_CheckSCGarbage_Pile4Timer;

	void ActionCheckSCGarbage_Pile4()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCGarbage_Pile4 m_CheckRandomLoot = SCGarbage_Pile4.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCGarbage_Pile4() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCGarbage_Pile4 Garbage_BinTimerCast = SCGarbage_Pile4.Cast( targetObject );
			...
			case 4:
				switch (Math.RandomInt(0, 7))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("Mag_Glock_15Rnd", pos) );
