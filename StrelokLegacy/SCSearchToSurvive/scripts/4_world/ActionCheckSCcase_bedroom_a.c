class ActionCheckSCcase_bedroom_a: ActionInteractBase
{
	ref Timer		m_CheckSCcase_bedroom_aTimer;

	void ActionCheckSCcase_bedroom_a()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCcase_bedroom_a m_CheckRandomLoot = SCcase_bedroom_a.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCcase_bedroom_a() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCcase_bedroom_a Garbage_BinTimerCast = SCcase_bedroom_a.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
            case 0:
				...
				{
    				case 0:
						ItemBase Garbage1 = ItemBase.Cast( GetGame().CreateObject("Pen_Blue", pos) );
						SetItemQuantity1(Garbage1);
            		break; 
					
           			case 1:
						ItemBase Garbage2 = ItemBase.Cast( GetGame().CreateObject("Rag", pos) );
			...
			switch (Math.RandomInt(0, 3))
				{
    				case 0:
						ItemBase Garbage3 = ItemBase.Cast( GetGame().CreateObject("Matchbox", pos) );
            ...
            case 2:
				...
				{
    				case 0:
						ItemBase Garbage6 = ItemBase.Cast( GetGame().CreateObject("DuctTape", pos) );
						SetItemQuantity6(Garbage6);
            		break; 
					
           			case 1:
						ItemBase Garbage7 = ItemBase.Cast( GetGame().CreateObject("Bear_Pink", pos) );
			...
			case 3:
				...
				{
    				case 0:
						ItemBase Garbage9 = ItemBase.Cast( GetGame().CreateObject("SodaCan_Cola", pos) );
						SetItemQuantity9(Garbage9);
            		break; 
					
           			case 1:
						ItemBase Garbage10 = ItemBase.Cast( GetGame().CreateObject("PersonalRadio", pos) );
			...
			case 4:
				...
				{
    				case 0:
						Weapon_Base Garbage13 = Weapon_Base.Cast( GetGame().CreateObject("Colt1911", pos) );
						SetItemQuantity13(Garbage13);
            		break; 
					
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("Flashlight", pos) );
