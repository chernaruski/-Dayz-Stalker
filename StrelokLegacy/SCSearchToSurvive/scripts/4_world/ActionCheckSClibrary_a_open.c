class ActionCheckSClibrary_a_open: ActionInteractBase
{
	ref Timer		m_CheckSClibrary_a_openTimer;

	void ActionCheckSClibrary_a_open()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SClibrary_a_open m_CheckRandomLoot = SClibrary_a_open.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSClibrary_a_open() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SClibrary_a_open Garbage_BinTimerCast = SClibrary_a_open.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
			...
			switch (Math.RandomInt(0, 3))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage4 = ItemBase.Cast( GetGame().CreateObject("BookHeartOfDarkness", pos) );
            ...
            case 2:
				...
				{
    				case 0:
						ItemBase Garbage6 = ItemBase.Cast( GetGame().CreateObject("BookNaturalSelection", pos) );
						SetItemQuantity6(Garbage6);
            		break; 
					
           			case 1:
						ItemBase Garbage7 = ItemBase.Cast( GetGame().CreateObject("BookBible", pos) );
			...
			case 3:
				...
				{
    				case 0:
						ItemBase Garbage9 = ItemBase.Cast( GetGame().CreateObject("MoneyRuble10", pos) );
			...
			case 4:
				...
				{
    				case 0:
						Weapon_Base Garbage13 = Weapon_Base.Cast( GetGame().CreateObject("BookRussianCheatSheet", pos) );
