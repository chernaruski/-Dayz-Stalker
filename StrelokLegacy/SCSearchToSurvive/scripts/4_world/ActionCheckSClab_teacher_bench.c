class ActionCheckSClab_teacher_bench: ActionInteractBase
{
	ref Timer		m_CheckSClab_teacher_benchTimer;

	void ActionCheckSClab_teacher_bench()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SClab_teacher_bench m_CheckRandomLoot = SClab_teacher_bench.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSClab_teacher_bench() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SClab_teacher_bench Garbage_BinTimerCast = SClab_teacher_bench.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
            case 0:
				...
				{
    				case 0:
						ItemBase Garbage1 = ItemBase.Cast( GetGame().CreateObject("LabCoat", pos) );
						SetItemQuantity1(Garbage1);
            		break; 
					
           			case 1:
						ItemBase Garbage2 = ItemBase.Cast( GetGame().CreateObject("MedicalScrubsPants_White", pos) );
			...
			switch (Math.RandomInt(0, 3))
				{
    				case 0:
						ItemBase Garbage3 = ItemBase.Cast( GetGame().CreateObject("MedicalScrubsShirt_White", pos) );
						SetItemQuantity3(Garbage3);
            		break; 
					
           			case 1:
						ItemBase Garbage4 = ItemBase.Cast( GetGame().CreateObject("Thermometer", pos) );
            ...
            case 2:
				...
				{
    				case 0:
						ItemBase Garbage6 = ItemBase.Cast( GetGame().CreateObject("Heatpack", pos) );
						SetItemQuantity6(Garbage6);
            		break; 
					
           			case 1:
						ItemBase Garbage7 = ItemBase.Cast( GetGame().CreateObject("PainkillerTablets", pos) );
			...
			case 3:
				...
				{
    				case 0:
						ItemBase Garbage9 = ItemBase.Cast( GetGame().CreateObject("TetracyclineAntibiotics", pos) );
						SetItemQuantity9(Garbage9);
            		break; 
					
           			case 1:
						ItemBase Garbage10 = ItemBase.Cast( GetGame().CreateObject("VitaminBottle", pos) );
			...
			case 4:
				switch (Math.RandomInt(0, 7))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("Morphine", pos) );
						SetItemQuantity14(Garbage14);
            		break;
					
					case 2:
						ItemBase Garbage16 = ItemBase.Cast( GetGame().CreateObject("Epinephrine", pos) );
            		break;
