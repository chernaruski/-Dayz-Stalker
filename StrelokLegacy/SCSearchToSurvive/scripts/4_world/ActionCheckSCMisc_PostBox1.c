class ActionCheckSCMisc_PostBox1: ActionInteractBase
{
	ref Timer		m_CheckSCMisc_PostBox1Timer;

	void ActionCheckSCMisc_PostBox1()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCMisc_PostBox1 m_CheckRandomLoot = SCMisc_PostBox1.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCMisc_PostBox1() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCMisc_PostBox1 Garbage_BinTimerCast = SCMisc_PostBox1.Cast( targetObject );
