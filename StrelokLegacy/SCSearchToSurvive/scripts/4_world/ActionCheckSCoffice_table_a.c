class ActionCheckSCoffice_table_a: ActionInteractBase
{
	ref Timer		m_CheckSCoffice_table_aTimer;

	void ActionCheckSCoffice_table_a()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCoffice_table_a m_CheckRandomLoot = SCoffice_table_a.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCoffice_table_a() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCoffice_table_a Garbage_BinTimerCast = SCoffice_table_a.Cast( targetObject );
			...
			case 4:
				switch (Math.RandomInt(0, 7))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("Universallight", pos) );
						SetItemQuantity14(Garbage14);
            		break;
					
					case 2:
						ItemBase Garbage16 = ItemBase.Cast( GetGame().CreateObject("Flashlight", pos) );
            		break;
