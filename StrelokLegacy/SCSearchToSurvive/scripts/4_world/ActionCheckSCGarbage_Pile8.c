class ActionCheckSCGarbage_Pile8: ActionInteractBase
{
	ref Timer		m_CheckSCGarbage_Pile8Timer;

	void ActionCheckSCGarbage_Pile8()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCGarbage_Pile8 m_CheckRandomLoot = SCGarbage_Pile8.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCGarbage_Pile8() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCGarbage_Pile8 Garbage_BinTimerCast = SCGarbage_Pile8.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
			...
			case 4:
				...
				{
    				case 0:
						Weapon_Base Garbage13 = Weapon_Base.Cast( GetGame().CreateObject("MKII", pos) );
						SetItemQuantity13(Garbage13);
            		break; 
					
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("Mag_MKII_10Rnd", pos) );
