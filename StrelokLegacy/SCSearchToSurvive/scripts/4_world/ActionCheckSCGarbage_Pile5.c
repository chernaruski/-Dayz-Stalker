class ActionCheckSCGarbage_Pile5: ActionInteractBase
{
	ref Timer		m_CheckSCGarbage_Pile5Timer;

	void ActionCheckSCGarbage_Pile5()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCGarbage_Pile5 m_CheckRandomLoot = SCGarbage_Pile5.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCGarbage_Pile5() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCGarbage_Pile5 Garbage_BinTimerCast = SCGarbage_Pile5.Cast( targetObject );
			...
			case 4:
				switch (Math.RandomInt(0, 7))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("Mag_1911_7Rnd", pos) );
