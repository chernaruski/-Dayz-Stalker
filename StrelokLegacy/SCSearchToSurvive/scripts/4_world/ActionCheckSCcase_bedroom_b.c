class ActionCheckSCcase_bedroom_b: ActionInteractBase
{
	ref Timer		m_CheckSCcase_bedroom_bTimer;

	void ActionCheckSCcase_bedroom_b()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCcase_bedroom_b m_CheckRandomLoot = SCcase_bedroom_b.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCcase_bedroom_b() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCcase_bedroom_b Garbage_BinTimerCast = SCcase_bedroom_b.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
            ...
            case 2:
				switch (Math.RandomInt(0, 3))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage7 = ItemBase.Cast( GetGame().CreateObject("Bear_White", pos) );
			...
			case 3:
				...
				{
    				case 0:
						ItemBase Garbage9 = ItemBase.Cast( GetGame().CreateObject("SodaCan_Pipsi", pos) );
			...
			case 4:
				...
				{
    				case 0:
						Weapon_Base Garbage13 = Weapon_Base.Cast( GetGame().CreateObject("FNX45", pos) );
