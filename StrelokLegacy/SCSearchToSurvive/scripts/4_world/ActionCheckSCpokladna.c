class ActionCheckSCpokladna: ActionInteractBase
{
	ref Timer		m_CheckSCpokladnaTimer;

	void ActionCheckSCpokladna()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCpokladna m_CheckRandomLoot = SCpokladna.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCpokladna() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCpokladna Garbage_BinTimerCast = SCpokladna.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
			...
			switch (Math.RandomInt(0, 3))
				{
    				case 0:
						ItemBase Garbage3 = ItemBase.Cast( GetGame().CreateObject("MoneyRuble1", pos) );
            ...
            case 2:
				...
				{
    				case 0:
						ItemBase Garbage6 = ItemBase.Cast( GetGame().CreateObject("MoneyRuble5", pos) );
						SetItemQuantity6(Garbage6);
            		break; 
					
           			case 1:
						ItemBase Garbage7 = ItemBase.Cast( GetGame().CreateObject("MoneyRuble5", pos) );
			...
			case 3:
				switch (Math.RandomInt(0, 4))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage10 = ItemBase.Cast( GetGame().CreateObject("MoneyRuble25", pos) );
			...
			case 4:
				switch (Math.RandomInt(0, 7))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("MoneyRuble25", pos) );
						SetItemQuantity14(Garbage14);
            		break;
					
					case 2:
						ItemBase Garbage16 = ItemBase.Cast( GetGame().CreateObject("MoneyRuble50", pos) );
            		break;
