class ActionCheckSCGarbage_Container_Plastic: ActionInteractBase
{
	ref Timer		m_CheckSCGarbage_Container_PlasticTimer;

	void ActionCheckSCGarbage_Container_Plastic()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCGarbage_Container_Plastic m_CheckRandomLoot = SCGarbage_Container_Plastic.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCGarbage_Container_Plastic() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCGarbage_Container_Plastic Garbage_BinTimerCast = SCGarbage_Container_Plastic.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
            case 0:
				switch (Math.RandomInt(0, 2))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage2 = ItemBase.Cast( GetGame().CreateObject("WaterBottle", pos) );
			...
			switch (Math.RandomInt(0, 3))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage4 = ItemBase.Cast( GetGame().CreateObject("WaterBottle", pos) );
            ...
            case 2:
				switch (Math.RandomInt(0, 3))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage7 = ItemBase.Cast( GetGame().CreateObject("Chemlight_Yellow", pos) );
			...
			case 3:
				...
				{
    				case 0:
						ItemBase Garbage9 = ItemBase.Cast( GetGame().CreateObject("BloodBagEmpty", pos) );
						SetItemQuantity9(Garbage9);
            		break; 
					
           			case 1:
						ItemBase Garbage10 = ItemBase.Cast( GetGame().CreateObject("Netting", pos) );
			...
			case 4:
				...
				{
    				case 0:
						Weapon_Base Garbage13 = Weapon_Base.Cast( GetGame().CreateObject("Glock19", pos) );
						SetItemQuantity13(Garbage13);
            		break; 
					
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("SmallProtectorCase", pos) );
