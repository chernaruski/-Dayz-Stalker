class ActionCheckSClocker_closed_v2: ActionInteractBase
{
	ref Timer		m_CheckSClocker_closed_v2Timer;

	void ActionCheckSClocker_closed_v2()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SClocker_closed_v2 m_CheckRandomLoot = SClocker_closed_v2.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSClocker_closed_v2() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SClocker_closed_v2 Garbage_BinTimerCast = SClocker_closed_v2.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
            case 0:
				switch (Math.RandomInt(0, 2))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage2 = ItemBase.Cast( GetGame().CreateObject("CanOpener", pos) );
			...
			switch (Math.RandomInt(0, 3))
				{
    				case 0:
						ItemBase Garbage3 = ItemBase.Cast( GetGame().CreateObject("KitchenKnife", pos) );
						SetItemQuantity3(Garbage3);
            		break; 
					
           			case 1:
						ItemBase Garbage4 = ItemBase.Cast( GetGame().CreateObject("SteakKnife", pos) );
            ...
            case 2:
				...
				{
    				case 0:
						ItemBase Garbage6 = ItemBase.Cast( GetGame().CreateObject("Pliers", pos) );
						SetItemQuantity6(Garbage6);
            		break; 
					
           			case 1:
						ItemBase Garbage7 = ItemBase.Cast( GetGame().CreateObject("Compass", pos) );
			...
			case 3:
				...
				{
    				case 0:
						ItemBase Garbage9 = ItemBase.Cast( GetGame().CreateObject("Hammer", pos) );
						SetItemQuantity9(Garbage9);
            		break; 
					
           			case 1:
						ItemBase Garbage10 = ItemBase.Cast( GetGame().CreateObject("Hatchet", pos) );
			...
			case 4:
				...
				{
    				case 0:
						Weapon_Base Garbage13 = Weapon_Base.Cast( GetGame().CreateObject("Hacksaw", pos) );
						SetItemQuantity13(Garbage13);
            		break; 
					
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("HandSaw", pos) );
