class ActionCheckSCtable_crushed: ActionInteractBase
{
	ref Timer		m_CheckSCtable_crushedTimer;

	void ActionCheckSCtable_crushed()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCtable_crushed m_CheckRandomLoot = SCtable_crushed.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCtable_crushed() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCtable_crushed Garbage_BinTimerCast = SCtable_crushed.Cast( targetObject );
