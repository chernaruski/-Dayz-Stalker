class ActionCheckSCGarbage_Pile6: ActionInteractBase
{
	ref Timer		m_CheckSCGarbage_Pile6Timer;

	void ActionCheckSCGarbage_Pile6()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCGarbage_Pile6 m_CheckRandomLoot = SCGarbage_Pile6.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCGarbage_Pile6() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCGarbage_Pile6 Garbage_BinTimerCast = SCGarbage_Pile6.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
			...
			case 4:
				...
				{
    				case 0:
						Weapon_Base Garbage13 = Weapon_Base.Cast( GetGame().CreateObject("Izh18", pos) );
						SetItemQuantity13(Garbage13);
            		break; 
					
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("M18SmokeGrenade_Red", pos) );
