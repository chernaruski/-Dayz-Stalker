class ActionCheckSCGarbage_Pile2: ActionInteractBase
{
	ref Timer		m_CheckSCGarbage_Pile2Timer;

	void ActionCheckSCGarbage_Pile2()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCGarbage_Pile2 m_CheckRandomLoot = SCGarbage_Pile2.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCGarbage_Pile2() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCGarbage_Pile2 Garbage_BinTimerCast = SCGarbage_Pile2.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
			...
			case 4:
				...
				{
    				case 0:
						Weapon_Base Garbage13 = Weapon_Base.Cast( GetGame().CreateObject("CZ75", pos) );
						SetItemQuantity13(Garbage13);
            		break; 
					
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("Mag_CZ75_15Rnd", pos) );
