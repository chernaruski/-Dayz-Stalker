class ActionCheckSCMisc_PostBox2: ActionInteractBase
{
	ref Timer		m_CheckSCMisc_PostBox2Timer;

	void ActionCheckSCMisc_PostBox2()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCMisc_PostBox2 m_CheckRandomLoot = SCMisc_PostBox2.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCMisc_PostBox2() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCMisc_PostBox2 Garbage_BinTimerCast = SCMisc_PostBox2.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
			...
			case 3:
				...
				{
    				case 0:
						ItemBase Garbage9 = ItemBase.Cast( GetGame().CreateObject("Nail", pos) );
			...
			case 4:
				...
				{
    				case 0:
						Weapon_Base Garbage13 = Weapon_Base.Cast( GetGame().CreateObject("PistolSuppressor", pos) );
						SetItemQuantity13(Garbage13);
            		break; 
					
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("FlashGrenade", pos) );
