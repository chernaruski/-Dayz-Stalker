class ActionCheckSCkitchen_unit_a_dz: ActionInteractBase
{
	ref Timer		m_CheckSCkitchen_unit_a_dzTimer;

	void ActionCheckSCkitchen_unit_a_dz()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCkitchen_unit_a_dz m_CheckRandomLoot = SCkitchen_unit_a_dz.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCkitchen_unit_a_dz() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCkitchen_unit_a_dz Garbage_BinTimerCast = SCkitchen_unit_a_dz.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
            case 0:
				switch (Math.RandomInt(0, 2))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage2 = ItemBase.Cast( GetGame().CreateObject("Rice", pos) );
			...
			switch (Math.RandomInt(0, 3))
				{
    				case 0:
						ItemBase Garbage3 = ItemBase.Cast( GetGame().CreateObject("SpaghettiCan", pos) );
            ...
            case 2:
				...
				{
    				case 0:
						ItemBase Garbage6 = ItemBase.Cast( GetGame().CreateObject("Vodka", pos) );
						SetItemQuantity6(Garbage6);
            		break; 
					
           			case 1:
						ItemBase Garbage7 = ItemBase.Cast( GetGame().CreateObject("CanOpener", pos) );
			...
			case 3:
				...
				{
    				case 0:
						ItemBase Garbage9 = ItemBase.Cast( GetGame().CreateObject("KitchenKnife", pos) );
			...
			case 4:
				switch (Math.RandomInt(0, 7))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("RGD5Grenade", pos) );
