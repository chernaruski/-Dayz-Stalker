class ActionCheckSCGarbage_Bin: ActionInteractBase
{
	ref Timer		m_CheckSCGarbage_BinTimer;

	void ActionCheckSCGarbage_Bin()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCGarbage_Bin m_CheckRandomLoot = SCGarbage_Bin.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCGarbage_Bin() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCGarbage_Bin Garbage_BinTimerCast = SCGarbage_Bin.Cast( targetObject );
