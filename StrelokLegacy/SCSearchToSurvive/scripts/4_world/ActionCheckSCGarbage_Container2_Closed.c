class ActionCheckSCGarbage_Container2_Closed: ActionInteractBase
{
	ref Timer		m_CheckSCGarbage_Container2_ClosedTimer;

	void ActionCheckSCGarbage_Container2_Closed()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCGarbage_Container2_Closed m_CheckRandomLoot = SCGarbage_Container2_Closed.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCGarbage_Container2_Closed() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCGarbage_Container2_Closed Garbage_BinTimerCast = SCGarbage_Container2_Closed.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
            case 0:
				switch (Math.RandomInt(0, 2))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage2 = ItemBase.Cast( GetGame().CreateObject("EpoxyPutty", pos) );
			...
			switch (Math.RandomInt(0, 3))
				{
    				case 0:
						ItemBase Garbage3 = ItemBase.Cast( GetGame().CreateObject("DuctTape", pos) );
            ...
            case 2:
				switch (Math.RandomInt(0, 3))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage7 = ItemBase.Cast( GetGame().CreateObject("Bear_Dark", pos) );
			...
			case 3:
				...
				{
    				case 0:
						ItemBase Garbage9 = ItemBase.Cast( GetGame().CreateObject("Roadflare", pos) );
						SetItemQuantity9(Garbage9);
            		break; 
					
           			case 1:
						ItemBase Garbage10 = ItemBase.Cast( GetGame().CreateObject("NailBox", pos) );
			...
			case 4:
				...
				{
    				case 0:
						Weapon_Base Garbage13 = Weapon_Base.Cast( GetGame().CreateObject("BaseballBat", pos) );
						SetItemQuantity13(Garbage13);
            		break; 
					
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("CableReel", pos) );
