class ActionCheckSCGarbage_Pile3: ActionInteractBase
{
	ref Timer		m_CheckSCGarbage_Pile3Timer;

	void ActionCheckSCGarbage_Pile3()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCGarbage_Pile3 m_CheckRandomLoot = SCGarbage_Pile3.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCGarbage_Pile3() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCGarbage_Pile3 Garbage_BinTimerCast = SCGarbage_Pile3.Cast( targetObject );
			...
			case 4:
				switch (Math.RandomInt(0, 7))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("Mag_FNX45_15Rnd", pos) );
