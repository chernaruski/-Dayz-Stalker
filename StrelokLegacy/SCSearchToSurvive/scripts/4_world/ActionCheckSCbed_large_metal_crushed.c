class ActionCheckSCbed_large_metal_crushed: ActionInteractBase
{
	ref Timer		m_CheckSCbed_large_metal_crushedTimer;

	void ActionCheckSCbed_large_metal_crushed()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCbed_large_metal_crushed m_CheckRandomLoot = SCbed_large_metal_crushed.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCbed_large_metal_crushed() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCbed_large_metal_crushed Garbage_BinTimerCast = SCbed_large_metal_crushed.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
            ...
            case 2:
				...
				{
    				case 0:
						ItemBase Garbage6 = ItemBase.Cast( GetGame().CreateObject("Pipe", pos) );
						SetItemQuantity6(Garbage6);
            		break; 
					
           			case 1:
						ItemBase Garbage7 = ItemBase.Cast( GetGame().CreateObject("Pipe", pos) );
			...
			case 4:
				switch (Math.RandomInt(0, 7))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("MetalPlate", pos) );
