class ActionCheckSCbag_dz: ActionInteractBase
{
	ref Timer		m_CheckSCbag_dzTimer;

	void ActionCheckSCbag_dz()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCbag_dz m_CheckRandomLoot = SCbag_dz.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCbag_dz() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCbag_dz Garbage_BinTimerCast = SCbag_dz.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
            case 0:
				...
				{
    				case 0:
						ItemBase Garbage1 = ItemBase.Cast( GetGame().CreateObject("Plum", pos) );
						SetItemQuantity1(Garbage1);
            		break; 
					
           			case 1:
						ItemBase Garbage2 = ItemBase.Cast( GetGame().CreateObject("Apple", pos) );
			...
			switch (Math.RandomInt(0, 3))
				{
    				case 0:
						ItemBase Garbage3 = ItemBase.Cast( GetGame().CreateObject("Pear", pos) );
						SetItemQuantity3(Garbage3);
            		break; 
					
           			case 1:
						ItemBase Garbage4 = ItemBase.Cast( GetGame().CreateObject("Tomato", pos) );
            ...
            case 2:
				...
				{
    				case 0:
						ItemBase Garbage6 = ItemBase.Cast( GetGame().CreateObject("Potato", pos) );
						SetItemQuantity6(Garbage6);
            		break; 
					
           			case 1:
						ItemBase Garbage7 = ItemBase.Cast( GetGame().CreateObject("GreenBellPepper", pos) );
			...
			case 3:
				...
				{
    				case 0:
						ItemBase Garbage9 = ItemBase.Cast( GetGame().CreateObject("Zucchini", pos) );
						SetItemQuantity9(Garbage9);
            		break; 
					
           			case 1:
						ItemBase Garbage10 = ItemBase.Cast( GetGame().CreateObject("Kiwi", pos) );
			...
			case 4:
				switch (Math.RandomInt(0, 7))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("Pumpkin", pos) );
						SetItemQuantity14(Garbage14);
            		break;
					
					case 2:
						ItemBase Garbage16 = ItemBase.Cast( GetGame().CreateObject("LactariusMushroom", pos) );
            		break;
