class ActionCheckSCGarbage_Container2_Open: ActionInteractBase
{
	ref Timer		m_CheckSCGarbage_Container2_OpenTimer;

	void ActionCheckSCGarbage_Container2_Open()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCGarbage_Container2_Open m_CheckRandomLoot = SCGarbage_Container2_Open.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCGarbage_Container2_Open() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCGarbage_Container2_Open Garbage_BinTimerCast = SCGarbage_Container2_Open.Cast( targetObject );
