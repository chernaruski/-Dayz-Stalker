class ActionCheckSCcashier: ActionInteractBase
{
	ref Timer		m_CheckSCcashierTimer;

	void ActionCheckSCcashier()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCcashier m_CheckRandomLoot = SCcashier.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCcashier() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCcashier Garbage_BinTimerCast = SCcashier.Cast( targetObject );
	 	...
	 	switch (Math.RandomInt(0, 5)) 
        {
			...
			switch (Math.RandomInt(0, 3))
				{
    				case 0:
						ItemBase Garbage3 = ItemBase.Cast( GetGame().CreateObject("HandcuffKeys", pos) );
						SetItemQuantity3(Garbage3);
            		break; 
					
           			case 1:
						ItemBase Garbage4 = ItemBase.Cast( GetGame().CreateObject("DuctTape", pos) );
            ...
            case 2:
				...
				{
    				case 0:
						ItemBase Garbage6 = ItemBase.Cast( GetGame().CreateObject("Paper", pos) );
			...
			case 3:
				...
				{
    				case 0:
						ItemBase Garbage9 = ItemBase.Cast( GetGame().CreateObject("MoneyRuble1", pos) );
			...
			case 4:
				switch (Math.RandomInt(0, 7))
				{
					...
					case 2:
						ItemBase Garbage16 = ItemBase.Cast( GetGame().CreateObject("MoneyRuble25", pos) );
            		break;
