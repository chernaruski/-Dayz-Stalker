class ActionCheckSCGarbage_Pile1: ActionInteractBase
{
	ref Timer		m_CheckSCGarbage_Pile1Timer;

	void ActionCheckSCGarbage_Pile1()
	{
	//	m_MessageSuccess = "";
	...
	override bool ActionCondition( PlayerBase player, ActionTarget target, ItemBase item )
	{
		...
		SCGarbage_Pile1 m_CheckRandomLoot = SCGarbage_Pile1.Cast( targetObject );

		if ( m_CheckRandomLoot && m_CheckRandomLoot.CanLootSCGarbage_Pile1() )
		{
			return true;
		}
		return false;
	...
	override void OnStartServer( ActionData action_data )
	{
		...
		SCGarbage_Pile1 Garbage_BinTimerCast = SCGarbage_Pile1.Cast( targetObject );
			...
			case 4:
				switch (Math.RandomInt(0, 7))
				{
            		...
            		break; 
           			...
           			case 1:
						ItemBase Garbage14 = ItemBase.Cast( GetGame().CreateObject("Mag_IJ70_8Rnd", pos) );
